...
SCENE_ORDER: list[tuple[str, str, str]] = [
    ...
    ("ch2_svd_reveal",      "ch2_06_intro_geo",    "SVDIntroScene"),
    ...
    ("ch4_geometry_compare", "ch4_21_trans2",      "SVDChapterTransition2"),
    ...
    ("ch4_geometry_compare", "ch4_28_sidebyside",  "SideBySideCompare"),
    # Chapter 5 — Applications
    ("ch5_applications",    "ch5_29_trans3",       "SVDChapterTransition3"),
...
def _entries_for(scene: str | None, chapter: str | None):
    if scene:
...
def main():
    ...
    if not (a.all or a.scene or a.chapter):
        p.print_help()
        return
    render(_entries_for(a.scene, a.chapter), a.quality, a.dry)
